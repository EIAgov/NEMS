...
# assumes microsoft visual studo 17.7.4 (2022) for link, etc. Set path to find Visual Studio Common7/Tools and Common7/IDE
  ...
  export LIB=$VCINSTALLDIR'\Tools\MSVC\14.43.34808\lib\x64;'$VSINSTALLDIR'\VC\Tools\MSVC\14.43.34808\lib\x64;'$VSINSTALLDIR'\VC\Tools\MSVC\14.43.34808\atlmfc\lib\x64;'$WINDOWSSDKINSTALLDIR'\Lib\'$WINDOWSSDKVERSION'\um\x64;'$WINDOWSSDKINSTALLDIR'\Lib\'$WINDOWSSDKVERSION'\ucrt\x64;'$LIB
  export INCLUDE=$VCINSTALLDIR'\VC\Tools\MSVC\14.43.34808\atlmfc\include;'$VCINSTALLDIR'\Tools\MSVC\14.43.34808\include;'$VSINSTALLDIR'\include;'$INCLUDE
 
  export VSINSTALLDIR='C:/Program Files/Microsoft Visual Studio/2022/Community'
  export VCINSTALLDIR=$VSINSTALLDIR'/VC'
  export PATHDOS=$VSINSTALLDIR'/Common7/IDE;'$VSINSTALLDIR'/VC/Tools/MSVC/14.43.34808/lib/x64;'$VSINSTALLDIR'/Common7/Tools;'$VCINSTALLDIR'/Tools/MSVC/14.43.34808/bin/Hostx64/x64;'$WINDOWSSDKINSTALLDIR'/bin/x64;'$VSINSTALLDIR'/Common7/IDE/CommonExtensions/Microsoft/CMake/Ninja;'$PATHDOS
