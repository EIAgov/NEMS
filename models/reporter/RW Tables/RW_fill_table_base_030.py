...
def fill_table_base_030(dfd, table_spec, table_id):
    ...
    #      Wood Stoves                                              
    #T30(8,IY,IS)=RSHTRS(IY,7)*.000001
    z[7] = dfd['RSHTRS'].loc[7]  * .000001
 
    #      Geothermal Heat Pumps                                    
    #T30(9,IY,IS)=RSHTRS(IY,8)*.000001
    ...
    z[10] = dfd['RSCOOLERS'].loc[1]  * .000001
 
    #      Natural Gas Heat Pumps                                   
    #T30(12,IY,IS)=RSCOOLERS(IY,2)*.000001
    z[11] = dfd['RSCOOLERS'].loc[2]  * .000001
 
    #      Geothermal Heat Pumps                                    
    #T30(13,IY,IS)=RSCOOLERS(IY,3)*.000001
    z[12] = dfd['RSCOOLERS'].loc[3]  * .000001
 
    #      Central Air Conditioners                                 
    #T30(14,IY,IS)=RSCOOLERS(IY,4)*.000001
    z[13] = dfd['RSCOOLERS'].loc[4]  * .000001
 
    #      Room Air Conditioners                                    
    #T30(15,IY,IS)=RSCOOLERS(IY,5)*.000001
    z[14] = dfd['RSCOOLERS'].loc[5]  * .000001
    ...
    z[16] = dfd['RSWATER'].loc[2]  * .000001
 
    #      Natural Gas                                              
    #T30(18,IY,IS)=RSWATER(IY,1)*.000001
    z[17] = dfd['RSWATER'].loc[1]  * .000001
 
    #      Distillate Fuel Oil                                      
    #T30(19,IY,IS)=RSWATER(IY,3)*.000001
    z[18] = dfd['RSWATER'].loc[3]  * .000001
 
    #      Propane                                                  
    #T30(20,IY,IS)=RSWATER(IY,4)*.000001
    z[19] = dfd['RSWATER'].loc[4]  * .000001
 
    #      Solar Thermal                                            
    #T30(21,IY,IS)=RSWATER(IY,5)*.000001
    z[20] = dfd['RSWATER'].loc[5]  * .000001
    ...
    z[22] = dfd['RSCOOK'].loc[3]  * .000001
 
    #      Natural Gas                                              
    #T30(24,IY,IS)=RSCOOK(IY,1)*.000001
    z[23] = dfd['RSCOOK'].loc[1]  * .000001
 
    #      Propane                                                  
    #T30(25,IY,IS)=RSCOOK(IY,2)*.000001
    z[24] = dfd['RSCOOK'].loc[2]  * .000001
    ...
    z[26] = dfd['RSDRY'].loc[2]  * .000001
 
    #      Natural Gas                                              
    #T30(28,IY,IS)=RSDRY(IY,1)*.000001
    z[27] = dfd['RSDRY'].loc[1]  * .000001
    ...
    z[29] = dfd['RSREF'] * .000001
 
    #      Freezers                                                 
    #T30(31,IY,IS)=RSFRZ(IY)*.000001
    z[30] = dfd['RSFRZ'] * .000001
    ...
    z[53] = dfd['CGRESCAP'].loc[11].loc[3]  / 1000.
 
    #        Solar Photovoltaic                                     
    #T30(55,IY,IS)=CGRESCAP(11,IY,8)/1000.
    z[54] = dfd['CGRESCAP'].loc[11].loc[8]  / 1000.
 
    #        Wind                                                   
    #T30(56,IY,IS)=CGRESCAP(11,IY,11)/1000.
    z[55] = dfd['CGRESCAP'].loc[11].loc[11] / 1000.
    ...
    z[57] = (dfd['CGRESGEN'].loc[11].loc[3].loc[1] + dfd['CGRESGEN'].loc[11].loc[3].loc[2]) / 1000.
 
    #        Solar Photovoltaic                                     
    #T30(59,IY,IS)=(CGRESGEN(11,IY,8,1)+CGRESGEN(11,IY,8,2))/1000.
    z[58] = (dfd['CGRESGEN'].loc[11].loc[8].loc[1] + dfd['CGRESGEN'].loc[11].loc[8].loc[2]) / 1000.
 
    #        Wind                                                   
    #T30(60,IY,IS)=(CGRESGEN(11,IY,11,1)+CGRESGEN(11,IY,11,2))/1000.
    z[59] = (dfd['CGRESGEN'].loc[11].loc[11].loc[1] + dfd['CGRESGEN'].loc[11].loc[11].loc[2]) / 1000.
    ...
    z[61] = (dfd['CGRESGEN'].loc[11].loc[3].loc[1] + dfd['CGRESGEN'].loc[11].loc[8].loc[1] + dfd['CGRESGEN'].loc[11].loc[11].loc[1]) / 1000.
 
    #          Generation for Own Use                               
    #T30(63,IY,IS)=(CGRESGEN(11,IY,3,2)+CGRESGEN(11,IY,8,2)+CGRESGEN(11,IY,11,2))/1000.
    z[62] = (dfd['CGRESGEN'].loc[11].loc[3].loc[2] + dfd['CGRESGEN'].loc[11].loc[8].loc[2] + dfd['CGRESGEN'].loc[11].loc[11].loc[2]) / 1000.
 
    #      Energy Input (trillion Btu)                              
 
    #        Natural Gas Fuel Cells                                 
    #T30(64,IY,IS)=CGRESQ(11,IY,3)
    z[63] = dfd['CGRESQ'].loc[11].loc[3]
 
    #        Solar Photovoltaic                                     
    #T30(65,IY,IS)=CGRESQ(11,IY,8)
    z[64] = dfd['CGRESQ'].loc[11].loc[8]
 
    #        Wind                                                   
    #T30(66,IY,IS)=CGRESQ(11,IY,11)
    z[65] = dfd['CGRESQ'].loc[11].loc[11]
