...
*Gross: threshold utilization rate - reduce refinery shutdown assumption in HOGS case
...
* NOMINAL fixed cost charges for existing capacity operates
  ...
  npv_WACFSSafetyPrice(WACFS_PetCategory,ActivePeriod)                   = npv1(WACFSSafetyPrice(WACFS_PetCategory,t),Rate(t));
...
* ** WACFS comment here please
  WACFS_Bio_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioProcess,WACFS_BioMode,ModelYears(t)) = sum((WACFS_Years(t),WACFS_BioStreams(Stream)),
     ( WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t)-
      WACFS_BioStream_PetCarbonFactor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t)) *
      ProcessTable(WACFS_BioStreams,WACFS_BioProcess,WACFS_BioMode) * WACFS_Bio_Energy_Density(WACFS_BioStreams) * 0.001);

  npv_WACFS_Bio_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioProcess,WACFS_BioMode,ActivePeriod) =
      npv2(WACFS_Bio_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioProcess,WACFS_BioMode,t),Rate(t));

  WACFS_Imp_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioImports,ModelYears(t)) = sum(WACFS_Years(t),
     (WACFS_BioImport_Carbon_Factor(WACFS_PetCategory,WACFS_BioImports,t) -
      WACFS_BioImport_PetCarbonFactor(WACFS_PetCategory,WACFS_BioImports,t)) *
      WACFS_Imp_Energy_Density(WACFS_BioImports) * 0.001 );

  npv_WACFS_Imp_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioImports,ActivePeriod) =
      npv2(WACFS_Imp_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_BioImports,t),Rate(t));



* add BiodImp to WACFS constraint (similar to EthIMP)
* need to hardcode CI data from FBD, FBD_FCO (WACFS_BioStream_Carbon_Factor, 1000 tonne Carbon/trill BTU)
* to define WACFS_BiodImp_CFactor (tonne Carbon/bbl)
  WACFS_BiodImp_Carbon_Factor(WACFS_PetCategory,t)   = WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,'FBD','FBD_FCO','FBD',t) ;
  WACFS_BiodImp_PetCarbonFactor(WACFS_PetCategory,t) = WACFS_PetStream_Carbon_Factor(WACFS_PetCategory,'DSUout',t);
  WACFS_BiodImp_CFactor(WACFS_PetCategory,WACFS_RefReg,ModelYears(t)) = sum(WACFS_Years(t),
     (WACFS_BiodImp_Carbon_Factor(WACFS_PetCategory,t) - WACFS_BiodImp_PetCarbonFactor(WACFS_PetCategory,t)) *
      WACFS_Bio_Energy_Density('FBD') * 0.001 );

  npv_WACFS_BiodImp_CFactor(WACFS_PetCategory,WACFS_RefReg,ActivePeriod) =
      npv2(WACFS_BiodImp_CFactor(WACFS_PetCategory,WACFS_RefReg,t),Rate(t));

* add RenewDImp to WACFS constraint
  WACFS_RenewDImp_Carbon_Factor(WACFS_PetCategory,t)   = WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,'GDT','GDT_FCO','RDH',t) ;
  WACFS_RenewDImp_PetCarbonFactor(WACFS_PetCategory,t) = WACFS_PetStream_Carbon_Factor(WACFS_PetCategory,'DSUout',t);
  WACFS_RenewDImp_CFactor(WACFS_PetCategory,WACFS_RefReg,ModelYears(t)) = sum(WACFS_Years(t),
     (WACFS_RenewDImp_Carbon_Factor(WACFS_PetCategory,t) - WACFS_RenewDImp_PetCarbonFactor(WACFS_PetCategory,t)) *
      WACFS_Bio_Energy_Density('RDH') * 0.001 );

  npv_WACFS_RenewDImp_CFactor(WACFS_PetCategory,WACFS_RefReg,ActivePeriod) =
      npv2(WACFS_RenewDImp_CFactor(WACFS_PetCategory,WACFS_RefReg,t),Rate(t));


  WACFS_Pet_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_PetStreams,ModelYears(t))$WACFS_PetStream_Carbon_Factor(WACFS_PetCategory,WACFS_PetStreams,t) =
      sum(WACFS_Years(t),
      (WACFS_PetStream_Carbon_Factor(WACFS_PetCategory,WACFS_PetStreams,WACFS_Years) - WACFS_Target(WACFS_PetCategory,WACFS_RefReg,WACFS_Years)) *
      WACFS_Pet_Energy_Density(WACFS_PetStreams,WACFS_Years) * 0.001);

  npv_WACFS_Pet_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_PetStreams,ActivePeriod) =
      npv2(WACFS_Pet_CFactor(WACFS_PetCategory,WACFS_RefReg,WACFS_PetStreams,t),Rate(t));

* hardcode CI for LandfillGas (1000 tonne Carbon/trill BTU)
  WACFS_LandfillGas_Carbon_Factor(WACFS_PetCategory) = 14.532 ;

* attach to new WACFS credit source:  WACFS_LandfillGas (trill BTU/yr)
* since WACFS_LandfillGas in trills, then divided by 365 in eq below; if trills/day, do not divide
  WACFS_LFGas_CFactor(WACFS_PetCategory,WACFS_Years)$WACFS_LandfillGas_Carbon_Factor(WACFS_PetCategory) = sum(WACFS_RefReg,
      (WACFS_LandfillGas_Carbon_Factor(WACFS_PetCategory) - WACFS_Target(WACFS_PetCategory,WACFS_RefReg,WACFS_Years)) / 365.0 );

  npv_WACFS_LFGas_CFactor(WACFS_PetCategory,ActivePeriod)$WACFS_LandfillGas_Carbon_Factor(WACFS_PetCategory) =
      npv2(WACFS_LFGas_CFactor(WACFS_PetCategory,t),Rate(t));

* Hardcode:    WACFS_LandfillGas_total(t)       (trill BTU)
* WACFS_LandfillGas_total(t) = 0.0 ;
* WACFS_LandfillGas_total(t) = 130.0 ;
  WACFS_LandfillGas_total('2018') = 16.0 ;
  WACFS_LandfillGas_total('2017') = WACFS_LandfillGas_total('2018') /1.12 ;
  WACFS_LandfillGas_total('2016') = WACFS_LandfillGas_total('2017') /1.18 ;
  WACFS_LandfillGas_total('2015') = WACFS_LandfillGas_total('2016') /1.30 ;
  Loop( t,
    If( (t.val < 2015),
      WACFS_LandfillGas_total(t) = WACFS_LandfillGas_total('2015') ;
    elseif( (t.val > 2018) and (t.val >= 2030)),
      WACFS_LandfillGas_total(t) = WACFS_LandfillGas_total(t-1)*1.05 ;
    elseif( (t.val > 2030) ),
      WACFS_LandfillGas_total(t) = WACFS_LandfillGas_total('2030') ;
    );
  );

  npv_WACFS_LandfillGas_total(ActivePeriod) =
      npv2(WACFS_LandfillGas_Total(t),Rate(t));


  WACFS_Alt_CFactor(WACFS_PetCategory,WACFS_Vehicle_Types,WACFS_Years)$WACFS_AltVehicle_Carbon_Factor(WACFS_PetCategory,WACFS_Vehicle_Types) = sum(WACFS_RefReg,
      (WACFS_AltVehicle_Carbon_Factor(WACFS_PetCategory,WACFS_Vehicle_Types) - WACFS_Target(WACFS_PetCategory,WACFS_RefReg,WACFS_Years)) / 365.0 );

  npv_WACFS_Alt_CFactor(WACFS_PetCategory,WACFS_Vehicle_Types,ActivePeriod)$WACFS_AltVehicle_Carbon_Factor(WACFS_PetCategory,WACFS_Vehicle_Types) =
      npv2(WACFS_Alt_CFactor(WACFS_PetCategory,WACFS_Vehicle_Types,t),Rate(t));

  npv_WACFS_AltVehicle_Demand(WACFS_PetCategory,WACFS_Vehicle_Types,WACFS_RefReg,ActivePeriod)$WACFS_AltVehicle_Carbon_Factor(WACFS_PetCategory,WACFS_Vehicle_Types) =
      npv2(WACFS_AltVehicle_Demand(WACFS_PetCategory,WACFS_Vehicle_Types,WACFS_RefReg,t),Rate(t));

  WACFS_Price(WACFS_PetCategory,WACFS_Years) = sum((LCFS_C,MNXYRS)$(WACFS_M2(WACFS_PetCategory,LCFS_C) and tMNXYRS(WACFS_Years,MNXYRS)),
      max(0,LFMMOUT_WACFS_Offset_Prc(LCFS_C,MNXYRS)) );

  npv_WACFS_Price(WACFS_PetCategory,ActivePeriod) = npv1(WACFS_Price(WACFS_PetCategory,t),Rate(t));

* Isolate ethanol factors from process/mode to account for transfers in and out of OR
  WACFS_Eth_CFactor(WACFS_PetCategory('CFGout'),WACFS_BioStreams(EthStream),t)$((sum((WACFS_BioProcess,WACFS_BioMode)$WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t), 1))>0) =
    sum((WACFS_BioProcess,WACFS_BioMode)$WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t),
     (WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t) -
      WACFS_BioStream_PetCarbonFactor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t)) * WACFS_Bio_Energy_Density(WACFS_BioStreams) * 0.001 ) /
    sum((WACFS_BioProcess,WACFS_BioMode)$WACFS_BioStream_Carbon_Factor(WACFS_PetCategory,WACFS_BioProcess,WACFS_BioMode,WACFS_BioStreams,t),
      1 ) ;

  npv_WACFS_Eth_CFactor(WACFS_PetCategory,WACFS_BioStreams,ActivePeriod) =
      npv2(WACFS_Eth_CFactor(WACFS_PetCategory,WACFS_BioStreams,t),Rate(t));
...
*CCATS data for co2 price
*  npv_CCATSDAT_CO2_PRC_DIS_45Q(DomRefReg,ActivePeriod)           = npv1(CCATSDAT_CO2_PRC_DIS_45Q_lfmm(DomRefReg,t),Rate(t))     ;
...
* turn off BPU,BTL,CTL,CBL,CBLCCS,CTLCCS,BTLCCS builds       esh 9/25/24
  BUILDS.fx(RefReg,RefType,Process,BldStep,ActivePeriod)$(LearningProcess(Process)) = 0;
...
*????
  ...
  WACFS_Pet_to_Bio.fx(WACFS_PetCategory,PrcPeriod)                   = 0 ;
  WACFS_Pet_Cst.fx(WACFS_PetCategory,ActivePeriod)$(not PrcPeriod(ActivePeriod)) = 0 ;
  WACFS_Bio_Sub.fx(WACFS_PetCategory,ActivePeriod)$(not PrcPeriod(ActivePeriod)) = 0 ;
  WACFSSafety.fx(WACFS_PetCategory,PrcPeriod)                        = 0 ;
  WACFS_AltVehicles.fx(WACFS_PetCategory,WACFS_Vehicle_Types,ActivePeriod) = sum(WACFS_RefReg,
    npv_WACFS_AltVehicle_Demand(WACFS_PetCategory,WACFS_Vehicle_Types,WACFS_RefReg,ActivePeriod)) ;
