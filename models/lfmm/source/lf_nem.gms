...
*** PMMRPT tables
     ...
     LFMMOUT_RENEWDEXP(MNUMCR,MNUMYR)         MBCD    Renewable diesel exports by census
...
*** MAM jobs investment module
     LFMMOUT_BUILDS(REFREG,M57,MNUMYR)         MBCD    Refinery process unit capacity builds by region unit type year
...
$Load LFMMOUT_RENEWDEXP,PMMRPT_BLDIMP,PMMRPT_CLLETHCD
