...
def read_icnv_file(input_file):
    """Read convergence input file and return a DataFrame with convergence settings and a list of variables for convergence test.
    ...
    -------
    pandas.DataFrame
        dataframe of variables to test for convergence
    
    pandas.DataFrame
        dataframe of variables to relax between cycles

    pandas.DataFrame
        dataframe of Convergence Summary Table
    
    list
        list of all available variables read-in from converge/input
    
    list
        list of filtered variables read-in from converge/input to test for convergence

    list
        list of filtered variables read-in from converge/input to apply relax function
    
    list
        list of filtered variables read-in from converge/input in the Convergence Summary Table

    """
    
    # Read in .csv input files aspandas.DataFrame
    ...
    df_rlx = df_rlx.drop(columns=['Test','Relax', 'QMATCH', 'AbsoluteTolerance','FractionTolerance'])
