...
def steovars_write_to_ngsteo(result_dict, pyfiler):
    ...
    with open(r'ngas/ngsteo.txt', 'w+') as f:
        ...
        f.write(write_aimms_variable("NGCCU_ENC(nn::YEAR)",yrs,po.ngccu_enc[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_ESC(nn::YEAR)",yrs,po.ngccu_esc[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_MAC(nn::YEAR)",yrs,po.ngccu_mac[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_MTN(nn::YEAR)",yrs,po.ngccu_mtn[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_NEC(nn::YEAR)",yrs,po.ngccu_nec[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_PAC(nn::YEAR)",yrs,po.ngccu_pac[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_SAC(nn::YEAR)",yrs,po.ngccu_sac[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_WNC(nn::YEAR)",yrs,po.ngccu_wnc[0:yrs],1990))
        f.write(write_aimms_variable("NGCCU_WSC(nn::YEAR)",yrs,po.ngccu_wsc[0:yrs],1990))
        f.write(write_aimms_variable("NGCCUUS(nn::YEAR)",yrs,po.ngccuus[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_ENC(nn::YEAR)",yrs,po.ngicu_enc[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_ESC(nn::YEAR)",yrs,po.ngicu_esc[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_MAC(nn::YEAR)",yrs,po.ngicu_mac[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_MTN(nn::YEAR)",yrs,po.ngicu_mtn[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_NEC(nn::YEAR)",yrs,po.ngicu_nec[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_PAC(nn::YEAR)",yrs,po.ngicu_pac[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_SAC(nn::YEAR)",yrs,po.ngicu_sac[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_WNC(nn::YEAR)",yrs,po.ngicu_wnc[0:yrs],1990))
        f.write(write_aimms_variable("NGICU_WSC(nn::YEAR)",yrs,po.ngicu_wsc[0:yrs],1990))
        f.write(write_aimms_variable("NGICUUS(nn::YEAR)",yrs,po.ngicuus[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_ENC(nn::YEAR)",yrs,po.ngrcu_enc[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_ESC(nn::YEAR)",yrs,po.ngrcu_esc[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_MAC(nn::YEAR)",yrs,po.ngrcu_mac[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_MTN(nn::YEAR)",yrs,po.ngrcu_mtn[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_NEC(nn::YEAR)",yrs,po.ngrcu_nec[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_PAC(nn::YEAR)",yrs,po.ngrcu_pac[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_SAC(nn::YEAR)",yrs,po.ngrcu_sac[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_WNC(nn::YEAR)",yrs,po.ngrcu_wnc[0:yrs],1990))
        f.write(write_aimms_variable("NGRCU_WSC(nn::YEAR)",yrs,po.ngrcu_wsc[0:yrs],1990))
        f.write(write_aimms_variable("NGRCUUS(nn::YEAR)",yrs,po.ngrcuus[0:yrs],1990))
        f.write(write_aimms_variable("NGEUDUS(nn::YEAR)",yrs,po.ngeudus[0:yrs],1990))
        f.write(write_aimms_variable("NGHHUUS(nn::YEAR)",yrs,po.nghhuus[0:yrs],1990))
        f.write(write_aimms_variable("NGSFPUS(nn::YEAR)",yrs,po.ngsfpus[0:yrs],1990))
        f.write(write_aimms_variable("NGLPPUS(nn::YEAR)",yrs,po.nglppus[0:yrs],1990))
        f.write(write_aimms_variable("NGACPUS(nn::YEAR)",yrs,po.ngacpus[0:yrs],1990))
        f.write(write_aimms_variable("NGTCPUS(nn::YEAR)",yrs,po.ngtcpus[0:yrs],1990))
        f.write(write_aimms_variable("BALIT(nn::YEAR)",yrs,po.balit[0:yrs],1990))
        f.write(write_aimms_variable("NGNWPUS(nn::YEAR)",yrs,po.ngnwpus[0:yrs],1990))
        f.write(write_aimms_variable("NGEXPUS_LNG(nn::YEAR)",yrs,po.ngexpus_lng[0:yrs],1990))
        f.write(write_aimms_variable("NGEXPUS_PIPE(nn::YEAR)",yrs,po.ngexpus_pipe[0:yrs],1990))
        f.write(write_aimms_variable("NGEXPUS(nn::YEAR)",yrs,po.ngexpus[0:yrs],1990))
        f.write(write_aimms_variable("NGIMPUS(nn::YEAR)",yrs,po.ngimpus[0:yrs],1990))
        f.write(write_aimms_variable("NGIMPUS_LNG(nn::YEAR)",yrs,po.ngimpus_lng[0:yrs],1990))
        f.write(write_aimms_variable("NGIMPUS_PIPE(nn::YEAR)",yrs,po.ngimpus_pipe[0:yrs],1990))
...
def steovars_clean_up(steovars_file, BASEYR, steovr, list_steo_var_name, STEO_VARS_KEEP, pyfiler):
    ...
    for idx, line in enumerate(lines):
        ...
        if data[0]=='':
            ...
            steovars_write_meta([r'STEO\YEAR']+data[SKIPYEARS+1:],'w+')
            data_in_memory[r'STEO\YEAR']=data[SKIPYEARS+1:]
            continue
