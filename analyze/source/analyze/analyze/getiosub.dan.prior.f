...
601         FORMAT(T5,A10,A10,G16.6)
         ELSE
            WRITE(FILE,602,ERR=13)RHSNAM,RNAME,V
602         FORMAT(T5,A16,T25,A16,T50,G16.6)
         ENDIF
CC ======= (JUST HAD 601)
         SWRHS = .TRUE.
600   CONTINUE
...
1201           FORMAT(1X,A2,T5,A10,A10,G16.6)
            ELSE
               WRITE(FILE,1202,ERR=13)BNDTYP,BNDNAM,CNAME,VL
1202           FORMAT(1X,A2,T5,A16,T25,A16,T50,G16.6)
            ENDIF
CC ======= (AND BELOW)
         ELSE
