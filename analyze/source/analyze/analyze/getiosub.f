...
402            FORMAT(T5,A16,T25,A16,T50,G12.6)
               GOTO 400
            ENDIF
CC =======
            IF(RNAME.EQ.' ')THEN
...
601         FORMAT(T5,A10,A10,G12.5)
         ELSE
            WRITE(FILE,602,ERR=13)RHSNAM,RNAME,V
602         FORMAT(T5,A16,T25,A16,T50,G12.5)
         ENDIF
CC ======= (JUST HAD 601)
         SWRHS = .TRUE.
600   CONTINUE
...
1201           FORMAT(1X,A2,T5,A10,A10,G12.5)
            ELSE
               WRITE(FILE,1202,ERR=13)BNDTYP,BNDNAM,CNAME,VL
1202           FORMAT(1X,A2,T5,A16,T25,A16,T50,G12.5)
            ENDIF
CC ======= (AND BELOW)
         ELSE
