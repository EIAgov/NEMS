...
!  28 columns for each range: first column of range put in position 33 of *_SHR (for 2022 normally), but holds seds-based 2023 share (not 2022).
!  Second column goes into position 34, for 2023) and holds share computed for 2023 which should match 1st column.  29th column is 2050
!  Shares should change over time unless the spreadsheet option to holds shares constant overt time is on.

        rname='ELRS_SHR';call getrngr(rname, ELRS_SHR(33),1,29,1)
        rname='ELCM_SHR';call getrngr(rname, ELCM_SHR(33),1,29,1)
        rname='ELTR_SHR';call getrngr(rname, ELTR_SHR(33),1,29,1)
        rname='ELIN_SHR';call getrngr(rname, ELIN_SHR(33),1,29,1)
        rname='NGRS_SHR';call getrngr(rname, NGRS_SHR(33),1,29,1)
        rname='NGCM_SHR';call getrngr(rname, NGCM_SHR(33),1,29,1)
        rname='NGTR_SHR';call getrngr(rname, NGTR_SHR(33),1,29,1)
        rname='NGIN_SHR';call getrngr(rname, NGIN_SHR(33),1,29,1)
        rname='NGEL_SHR';call getrngr(rname, NGEL_SHR(33),1,29,1)
        rname='GPTR_SHR';call getrngr(rname, GPTR_SHR(33),1,29,1)
        rname='LPIN_SHR';call getrngr(rname, LPIN_SHR(33),1,29,1)
        rname='CLCM_SHR';call getrngr(rname, CLCM_SHR(33),1,29,1)
        rname='CLIN_SHR';call getrngr(rname, CLIN_SHR(33),1,29,1)
        rname='CLEL_SHR';call getrngr(rname, CLEL_SHR(33),1,29,1)
        rname='MGCM_SHR';call getrngr(rname, MGCM_SHR(33),1,29,1)
        rname='MGTR_SHR';call getrngr(rname, MGTR_SHR(33),1,29,1)
        rname='MGIN_SHR';call getrngr(rname, MGIN_SHR(33),1,29,1)
        rname='JFTR_SHR';call getrngr(rname, JFTR_SHR(33),1,29,1)
        rname='DSRS_SHR';call getrngr(rname, DSRS_SHR(33),1,29,1)
        rname='DSCM_SHR';call getrngr(rname, DSCM_SHR(33),1,29,1)
        rname='DSTR_SHR';call getrngr(rname, DSTR_SHR(33),1,29,1)
        rname='DSIN_SHR';call getrngr(rname, DSIN_SHR(33),1,29,1)
        rname='DSEL_SHR';call getrngr(rname, DSEL_SHR(33),1,29,1)
        rname='KSRS_SHR';call getrngr(rname, KSRS_SHR(33),1,29,1)
        rname='KSCM_SHR';call getrngr(rname, KSCM_SHR(33),1,29,1)
        rname='KSIN_SHR';call getrngr(rname, KSIN_SHR(33),1,29,1)
        rname='LGRS_SHR';call getrngr(rname, LGRS_SHR(33),1,29,1)
        rname='LGCM_SHR';call getrngr(rname, LGCM_SHR(33),1,29,1)
        rname='LGTR_SHR';call getrngr(rname, LGTR_SHR(33),1,29,1)
        rname='LGIN_SHR';call getrngr(rname, LGIN_SHR(33),1,29,1)
        rname='RSCM_SHR';call getrngr(rname, RSCM_SHR(33),1,29,1)
        rname='RSTR_SHR';call getrngr(rname, RSTR_SHR(33),1,29,1)
        rname='RSIN_SHR';call getrngr(rname, RSIN_SHR(33),1,29,1)
        rname='RSEL_SHR';call getrngr(rname, RSEL_SHR(33),1,29,1)
        rname='SGIN_SHR';call getrngr(rname, SGIN_SHR(33),1,29,1)
        rname='PCIN_SHR';call getrngr(rname, PCIN_SHR(33),1,29,1)
!        rname='PCEL_SHR';call getrngr(rname, PCEL_SHR(33),1,29,1)
        rname='PCAS_SHR';call getrngr(rname, PCAS_SHR(33),1,29,1)
        rname='ASIN_SHR';call getrngr(rname, ASIN_SHR(33),1,29,1)
        rname='OTTR_SHR';call getrngr(rname, OTTR_SHR(33),1,29,1)
        rname='OTIN_SHR';call getrngr(rname, OTIN_SHR(33),1,29,1)
        rname='ETTR_SHR';call getrngr(rname, ETTR_SHR(33),1,29,1)
        rname='UREL_SHR';call getrngr(rname, UREL_SHR(33),1,29,1)
        rname='HOIN_SHR';call getrngr(rname, HOIN_SHR(33),1,29,1)
        rname='HOEL_SHR';call getrngr(rname, HOEL_SHR(33),1,29,1)
        rname='GERS_SHR';call getrngr(rname, GERS_SHR(33),1,29,1)
        rname='GEIN_SHR';call getrngr(rname, GEIN_SHR(33),1,29,1)
        rname='GEEL_SHR';call getrngr(rname, GEEL_SHR(33),1,29,1)
        rname='BMRS_SHR';call getrngr(rname, BMRS_SHR(33),1,29,1)
        rname='BMCM_SHR';call getrngr(rname, BMCM_SHR(33),1,29,1)
        rname='BMIN_SHR';call getrngr(rname, BMIN_SHR(33),1,29,1)
        rname='BMEL_SHR';call getrngr(rname, BMEL_SHR(33),1,29,1)
        rname='MSIN_SHR';call getrngr(rname, MSIN_SHR(33),1,29,1)
        rname='STRS_SHR';call getrngr(rname, STRS_SHR(33),1,29,1)
        rname='STCM_SHR';call getrngr(rname, STCM_SHR(33),1,29,1)
        rname='STIN_SHR';call getrngr(rname, STIN_SHR(33),1,29,1)
        rname='STEL_SHR';call getrngr(rname, STEL_SHR(33),1,29,1)
        rname='WIIN_SHR';call getrngr(rname, WIIN_SHR(33),1,29,1)
        rname='WIEL_SHR';call getrngr(rname, WIEL_SHR(33),1,29,1)
        rname='EIEL_SHR';call getrngr(rname, EIEL_SHR(33),1,29,1)
