...
!     SO2 INPUTS
!
      IF ((CURIYR + UHBSYR) .EQ. (TRANRULE1 - UPSCLT) .OR. ((CURIYR + UHBSYR) .GE. TRANRULE1 .AND. (CURIYR + UHBSYR) .EQ. UESTYR))THEN
...
!       END DO
        ...
        END DO
      END IF
      IF ((CURIYR + UHBSYR) .EQ. TRANRULE1 .OR. ((CURIYR + UHBSYR) .GE. TRANRULE1 .AND. (CURIYR + UHBSYR) .EQ. UESTYR))THEN
        DO SO2 = 1 , MX_SO2_GRP
