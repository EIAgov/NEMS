...
! WTI adjust
        ...
        LASTYRADJ = 2050
		WTIDECLINE = 0.00 ! INITIAL ADJUSTMENT WTI IN YEAR HISTLYR+1
        if (curiyr+1989 .gt. HISTLYR+1989) THEN 
			WTI_PRICE(curiyr) = RFCRUDEWHP(2,1,curiyr)
			if (curiyr+1989 .GE. HISTLYR+1989+12 .AND. curiyr+1989 .LE. LASTYRADJ) then  
				WTIADJSLOPE = (1.0 / ((HISTLYR+1989+1) - LASTYRADJ))
				WTIADJINTERCEPT = 1.0 - WTIADJSLOPE * (HISTLYR+1989+1)		   
				WTIADJFACT = -(WTIADJSLOPE + WTIADJINTERCEPT)/2500
			ELSE
				WTIADJFACT = 0.0
			endif
