...
! TO THE START OF THE COMMON BLOCK AND EQUAL TO THE LENGTH OF THE COMMON BLOCK
      ...
      ELSEIF (LABEL.EQ.'EMOBLK') THEN
             CALL FCOP(EQ_EMOBLK(IPOINT),ARRAY,NSIZE,IOPT)
      ELSEIF (LABEL.EQ.'CALSHR') THEN
             CALL FCOP(EQ_CASHR(IPOINT),ARRAY,NSIZE,IOPT)
      ELSEIF (LABEL.EQ.'INDEPM') THEN
             CALL FCOP(EQ_INEPM(IPOINT),ARRAY,NSIZE,IOPT)
      ELSEIF (LABEL.EQ.'CCATSDAT') THEN
             CALL FCOP(EQ_CCATSOUT(IPOINT),ARRAY,NSIZE,IOPT)
       ELSE
             IRET=1
      ENDIF
      RETURN
